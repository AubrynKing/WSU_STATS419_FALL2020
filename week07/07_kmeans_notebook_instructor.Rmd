...
#packageVersion("imdb");#
#Thsi is literally the same thing as hclust
...
path.to.week7 = "C:/gitfolder/WSU_STATS419_FALL2020/"; #I changed this to my own path to make it worn
...
example.datasets.path = "C:/gitfolder/WSU_STATS419_FALL2020/datasets/"; #path to protein

protein.file2 = paste0(example.datasets.path,"Protein/pipe-format-protein.txt");
...
myFinalAnswer = 4;  # 3 or 4, unless you want to defend 8 ...
